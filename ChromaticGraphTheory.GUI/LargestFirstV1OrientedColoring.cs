...
{
    public class LargestFirstV1OrientedColoring
    {
        public IBidirectionalGraph<int, IEdge<int>> Graph { get; private set; }

        public LargestFirstV1OrientedColoring(IBidirectionalGraph<int, IEdge<int>> graph)
        {
            Graph = graph;
        }
        ...
        public (int, int, int)[] Execute()
        {
            ...
            orderedVertices.Sort((v1, v2) => Graph.Degree(v2) - Graph.Degree(v1));
